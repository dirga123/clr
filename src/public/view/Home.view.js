	...
	sap.ui.jsview('sap.clr.view.Home', {
		...
		createContent: function (oController) {
			...
			var oLandscapesTile = new StandardTile(this.createId('landscapesTile'), {
				...
				title: '{i18n>homeLandscapeManagementTitle}',
				number: '{home>/landscapes}',
				numberUnit: '{i18n>homeLandscapeManagementUnit}',
			...
			var oVL = new VerticalLayout({
				content: new VerticalLayout({
					content: [
						new sap.m.ObjectHeader({title: '{i18n>homeLandscapeManagement}'}).addStyleClass("lpHeader"),
