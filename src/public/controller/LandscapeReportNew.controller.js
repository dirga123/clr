sap.ui.define([
	...
	return BaseController.extend('sap.clr.controller.LandscapeReportNew', {
		onInit: function() {
			jQuery.sap.log.info('LandscapeReportNew.controller:onInit');
...
*/
			this.getRouter().getRoute('landscapeReportNew').attachPatternMatched(
				this._onObjectMatched, this
			);
		},

		onPressRefresh: function() {
			jQuery.sap.log.info('LandscapeReportNew.controller:onPressRefresh');
		...
		onPressPrint: function(oEvent) {
			jQuery.sap.log.info('LandscapeReportNew.controller:onPressPrint');
		...
		onPressExport: function() {
			jQuery.sap.log.info('LandscapeReportNew.controller:onPressExport');
		},
		...
		_onObjectMatched: function (oEvent) {
			jQuery.sap.log.info('LandscapeReportNew.controller:_onObjectMatched');
		...
		_requestData: function() {
			jQuery.sap.log.info('LandscapeReportNew.controller:_requestData');
		...
		_requestCompleted: function(oEvent) {
			jQuery.sap.log.info('LandscapeReportNew.controller:_requestCompleted');
		...
		_bindView: function (sPath) {
			jQuery.sap.log.info('LandscapeReportNew.controller:_bindView');
